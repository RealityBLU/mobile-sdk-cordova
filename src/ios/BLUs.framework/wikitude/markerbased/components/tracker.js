var Tracker = {
    ...
    scanOnce: function () {
        ...
        World.cloudRecognitionService.startContinuousRecognition(this.intervalRecognition, this.onSingleInterruption, this.onRecognition, this.onRecognitionError);
