var NativeBridge = {
    init: function (value) {
        ...
        if(value) uiUtil.hideAndStartAnimate();
    },
    ...
    customizationFileExist: function (element, path) {
        uiCustomization.customizeElements(element, path)
    },
    ...
    performScanQR: function () {
        AR.platform.sendJSONObject({action: "perform_scan_qr_code"});
    },
    ...
    setSmallLoadingSpinner: function () {
        PlaceHolder.isSmallLoadingSpinner = true;
    },
