...
const World = {
  ...
  */
  ...
  takeData: function (value, flagText) {
    if (PlatformHandler.platformString() === "android") uiCustomization.customize();
  ...
  startAr: function (isSmart) {
    ...
    if (PlatformHandler.platformString() === "ios") uiCustomization.customize();
  ...
  createOverlays: function (isSmart) {
    ...
    const imagePath = uiCustomization.surfaceSpinnerSearchPath || "assets/sprite_color.png";
    World.initModel = new AR.AnimatedImageDrawable(new AR.ImageResource(imagePath), 0.6, 270, 270, {});
  ...
  changeTrackerState: function () {
    ...
    if (World.isARInitializing()) {
      ...
      document.getElementById("tracking-model-back-to-gallery-button-container").style.visibility = 'visible';
      ...
      document.getElementById("tracking-model-back-to-gallery-button-container").style.visibility = 'hidden';
      document.getElementById('miss-view-marker').style.visibility = 'hidden';
  ...
  placeMarkerModel: function (xpos, ypos) {
    if (World.isARTracking()) {
      if (World.markerModel === null) {
        const imagePath = uiCustomization.surfaceSpinnerReadyPath || "assets/sprite_white.png";
        World.markerModel = new AR.AnimatedImageDrawable(new AR.ImageResource(imagePath), 0.5, 270, 270, {
